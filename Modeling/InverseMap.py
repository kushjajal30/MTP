...
def get_terrain_from_rem(rem,ref_rem,gen,path,updates,lr,lambda_regularizer_l1,lambda_regularizer_l2,lambda_regularizer_cnn,lambda_similarity,lambda_morans_i):
    ...
    for iteration in tqdm(range(updates)):
        ...
        out_rem = gen(torch.cat([recon_ter,ref_rem],dim=1))
        ...
        loss = lambda_similarity * l2_loss + lambda_regularizer_l1 * l1_regularizer_term + lambda_regularizer_l2 * l2_regularizer_term + lambda_regularizer_cnn * cnn_regularizer + lambda_morans_i * morans_i
